...
func DispatchOnce(ctx context.Context, cli *daemon.Client, k kubernetes.Interface, namespace, imagePullSecret string, r Registered, cb ClaudeBrokerOptions, rc RepoCacheOptions, gh GitHubTokenOptions, extraEnv []WorkerSecretEnvVar) (bool, error) {
	...
	if _, err := DispatchJob(ctx, k, namespace, r, *task, imagePullSecret, pvc, cb, rc, gh, extraEnv); err != nil {
